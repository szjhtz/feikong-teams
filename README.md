...
- **自定义智能体配置**：Web 设置页按智能体、圆桌、Deep 等独立页签组织配置，可创建智能体，并通过搜索、多选和工具说明快速配置内置工具、MCP 工具以及按智能体隔离的 SSH 连接
- **Deep 模式配置**：可在 Web 设置页调整 Deep 智能体的计划清单、工作区文件、Shell、子任务委派、上下文注入、额外工具和提示词
